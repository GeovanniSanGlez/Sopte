<html class=" no-touch"><head lang="es">
	<meta charset="UTF-8">
...
<body class="with-side-menu">
	...
	<nav class="side-menu jspScrollable" tabindex="0" style="overflow: hidden; padding: 0px; width: 240px;">
	    
	
	    
	<div class="jspContainer" style="width: 239px; height: 731px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 227px;"><ul class="side-menu-list">
	        ...
	        <li class="magenta with-sub">
	            ...
	            <ul>
	                ...
	                <a href="bootstrap-datatables.html"><span class="lbl">Bootstrap Table</span></a>
	    ...
	    </section></div><div class="jspVerticalBar"><div class="jspCap jspCapTop"></div><div class="jspTrack" style="height: 731px;"><div class="jspDrag" style="height: 465px;"><div class="jspDragTop"></div><div class="jspDragBottom"></div></div></div><div class="jspCap jspCapBottom"></div></div></div></nav><!--.side-menu-->
